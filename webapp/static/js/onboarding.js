...
(function () {
  ...
  const aA = cont.dataset.anioActual || (new Date().getFullYear() + '');
  const aP = cont.dataset.anioAnterior || (new Date().getFullYear() - 1 + '');
  ...
  const fraseEl = document.getElementById('ob-frase');
  let i = 0;
